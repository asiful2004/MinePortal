...
export default function NewsCard({ article, featured = false }: NewsCardProps) {
  ...
  return (
    <Card 
      className={`card-hover overflow-hidden ${featured ? 'md:col-span-2 lg:col-span-3' : ''}`}
    ...
    >
      ...
      <CardContent className={featured ? 'p-8' : 'p-6'}>
        ...
        <h3 
          className={`font-bold mb-3 text-foreground ${featured ? 'text-2xl md:text-3xl' : 'text-lg'}`}
